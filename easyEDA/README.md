...
1.	Input signals at 200 Hz (with different voltages) from other neurons into the soma of the neuron under consideration.
...
3.	Operating principle: The circuit generates an output pulse when the two signals (PRE and POST) overlap in time. At that moment, a higher-voltage pulse is applied to the memristor, changing its resistance.
