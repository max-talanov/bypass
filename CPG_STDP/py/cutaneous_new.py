...
def our_stim():
    ...
    for i in range(nsyn):
        ...
        nc = h.NetCon(cell_cut.soma(0.5)._ref_v,
...
if __name__ == '__main__':
    ...
    output_file('change_res_cut.html')
