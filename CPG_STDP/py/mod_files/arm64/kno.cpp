...
#define t _nt->_t
#define dt _nt->_dt
#define gkmax _ml->template fpfield<0>(_iml)
#define gkmax_columnindex 0
#define gk _ml->template fpfield<1>(_iml)
#define gk_columnindex 1
#define sinf _ml->template fpfield<2>(_iml)
#define sinf_columnindex 2
#define stau _ml->template fpfield<3>(_iml)
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       _nrn_mechanism_field<double>{"gkmax"} /* 0 */,
                                       _nrn_mechanism_field<double>{"gk"} /* 1 */,
                                       _nrn_mechanism_field<double>{"sinf"} /* 2 */,
                                       _nrn_mechanism_field<double>{"stau"} /* 3 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 K_No /Users/ann/memCPG/CPG_STDP/py/mod_files/kno.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "K_No.mod   nodal slow potassium channel";
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_K_No. Requires prior call to setdata_K_No and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/ann/memCPG/CPG_STDP/py/mod_files/kno.mod";
