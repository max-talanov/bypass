...
#define t _nt->_t
#define dt _nt->_dt
#define c0cleft _ml->template fpfield<0>(_iml)
#define c0cleft_columnindex 0
#define h _ml->template fpfield<1>(_iml)
#define h_columnindex 1
#define tx1 _ml->template fpfield<2>(_iml)
#define tx1_columnindex 2
#define a _ml->template fpfield<3>(_iml)
#define a_columnindex 3
#define serotonin _ml->template fpfield<4>(_iml)
#define serotonin_columnindex 4
#define diff _ml->template fpfield<5>(_iml)
  ...
  if (nrn_point_prop_) {
   ...
   _ppvar = nrn_prop_datum_alloc(_mechtype, 2, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 9);
 	...
 	c0cleft = _parm_default[0]; /* 20 */
 	h = _parm_default[1]; /* 0 */
 	tx1 = _parm_default[2]; /* 0 */
 	a = _parm_default[3]; /* 20 */
  }
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 9);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       _nrn_mechanism_field<double>{"c0cleft"} /* 0 */,
                                       _nrn_mechanism_field<double>{"h"} /* 1 */,
                                       _nrn_mechanism_field<double>{"tx1"} /* 2 */,
                                       _nrn_mechanism_field<double>{"a"} /* 3 */,
                                       _nrn_mechanism_field<double>{"serotonin"} /* 4 */,
                                       _nrn_mechanism_field<double>{"diff"} /* 5 */,
 ...
 pnt_receive_size[_mechtype] = 1;
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 slow_5HT /Users/ann/memCPG/CPG_STDP/py/mod_files/slow5HT.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
 static double PI = 3.1415927;
static int _reset;
static const char *modelname = "slow 5HT diffusion";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/ann/memCPG/CPG_STDP/py/mod_files/slow5HT.mod";
