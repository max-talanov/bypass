...
#define RLwindhebb _ml->template fpfield<4>(_iml)
#define RLwindhebb_columnindex 4
#define RLwindanti _ml->template fpfield<5>(_iml)
#define RLwindanti_columnindex 5
#define useRLexp _ml->template fpfield<6>(_iml)
#define useRLexp_columnindex 6
#define RLlenhebb _ml->template fpfield<7>(_iml)
#define RLlenhebb_columnindex 7
#define RLlenanti _ml->template fpfield<8>(_iml)
#define RLlenanti_columnindex 8
#define RLhebbwt _ml->template fpfield<9>(_iml)
#define RLhebbwt_columnindex 9
#define RLantiwt _ml->template fpfield<10>(_iml)
#define RLantiwt_columnindex 10
#define wmax _ml->template fpfield<11>(_iml)
#define wmax_columnindex 11
#define softthresh _ml->template fpfield<12>(_iml)
#define softthresh_columnindex 12
#define STDPon _ml->template fpfield<13>(_iml)
#define STDPon_columnindex 13
#define RLon _ml->template fpfield<14>(_iml)
#define RLon_columnindex 14
#define verbose _ml->template fpfield<15>(_iml)
#define verbose_columnindex 15
#define skip _ml->template fpfield<16>(_iml)
#define skip_columnindex 16
#define tlastpre _ml->template fpfield<17>(_iml)
#define tlastpre_columnindex 17
#define tlastpost _ml->template fpfield<18>(_iml)
#define tlastpost_columnindex 18
#define tlasthebbelig _ml->template fpfield<19>(_iml)
#define tlasthebbelig_columnindex 19
#define tlastantielig _ml->template fpfield<20>(_iml)
#define tlastantielig_columnindex 20
#define interval _ml->template fpfield<21>(_iml)
#define interval_columnindex 21
#define deltaw _ml->template fpfield<22>(_iml)
#define deltaw_columnindex 22
#define newweight _ml->template fpfield<23>(_iml)
#define newweight_columnindex 23
#define gv _ml->template fpfield<24>(_iml)
#define gv_columnindex 24
#define _tsav _ml->template fpfield<25>(_iml)
...
static Datum *_ppvar;
 ...
 static double _hoc_antiRL(void*);
 static double _hoc_adjustweight(void*);
 static double _hoc_hebbRL(void*);
 static double _hoc_reward_punish(void*);
  ...
  if (nrn_point_prop_) {
   ...
   _ppvar = nrn_prop_datum_alloc(_mechtype, 4, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 26);
 	...
 	antiwt = _parm_default[3]; /* -0.003 */
 	RLwindhebb = _parm_default[4]; /* 20 */
 	RLwindanti = _parm_default[5]; /* 20 */
 	useRLexp = _parm_default[6]; /* 0 */
 	RLlenhebb = _parm_default[7]; /* 100 */
 	RLlenanti = _parm_default[8]; /* 100 */
 	RLhebbwt = _parm_default[9]; /* 1 */
 	RLantiwt = _parm_default[10]; /* -1 */
 	wmax = _parm_default[11]; /* 15 */
 	softthresh = _parm_default[12]; /* 0 */
 	STDPon = _parm_default[13]; /* 1 */
 	RLon = _parm_default[14]; /* 0 */
 	verbose = _parm_default[15]; /* 0 */
 	skip = _parm_default[16]; /* 0 */
  }
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 26);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"RLwindhebb"} /* 4 */,
                                       _nrn_mechanism_field<double>{"RLwindanti"} /* 5 */,
                                       _nrn_mechanism_field<double>{"useRLexp"} /* 6 */,
                                       _nrn_mechanism_field<double>{"RLlenhebb"} /* 7 */,
                                       _nrn_mechanism_field<double>{"RLlenanti"} /* 8 */,
                                       _nrn_mechanism_field<double>{"RLhebbwt"} /* 9 */,
                                       _nrn_mechanism_field<double>{"RLantiwt"} /* 10 */,
                                       _nrn_mechanism_field<double>{"wmax"} /* 11 */,
                                       _nrn_mechanism_field<double>{"softthresh"} /* 12 */,
                                       _nrn_mechanism_field<double>{"STDPon"} /* 13 */,
                                       _nrn_mechanism_field<double>{"RLon"} /* 14 */,
                                       _nrn_mechanism_field<double>{"verbose"} /* 15 */,
                                       _nrn_mechanism_field<double>{"skip"} /* 16 */,
                                       _nrn_mechanism_field<double>{"tlastpre"} /* 17 */,
                                       _nrn_mechanism_field<double>{"tlastpost"} /* 18 */,
                                       _nrn_mechanism_field<double>{"tlasthebbelig"} /* 19 */,
                                       _nrn_mechanism_field<double>{"tlastantielig"} /* 20 */,
                                       _nrn_mechanism_field<double>{"interval"} /* 21 */,
                                       _nrn_mechanism_field<double>{"deltaw"} /* 22 */,
                                       _nrn_mechanism_field<double>{"newweight"} /* 23 */,
                                       _nrn_mechanism_field<double>{"gv"} /* 24 */,
                                       _nrn_mechanism_field<double>{"_tsav"} /* 25 */,
 ...
 pnt_receive_size[_mechtype] = 1;
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 STDP /Users/ann/memCPG/CPG_STDP/py/mod_files/stdp.mod\n");
...
{   neuron::legacy::set_globals_from_prop(_pnt->_prop, _ml_real, _ml, _iml);
 ...
 _tsav = t;   if (_lflag == 1. ) {*(_tqitem) = nullptr;}
 {
   ...
   if ( ( _lflag  == - 1.0 )  && ( tlastpre  != t - 1.0 ) ) {
     ...
     if ( verbose > 1.0 ) {
       printf ( "I in net_receive, flagg == -1 and tlastpre != t-1" ) ;
       }
     }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/ann/memCPG/CPG_STDP/py/mod_files/stdp.mod";
  ...
  "        if (softthresh == 1) { deltaw = softthreshold(deltaw) }  : If we have soft-thresholding on, apply it.  \n"
  "        adjustweight(deltaw) : Adjust the weight.\n"
  "        if (verbose > 0) { printf(\"I in reward_punish\")}\n"
