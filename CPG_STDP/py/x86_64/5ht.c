...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 r5ht3a /home/yulia/bypass/CPG_STDP/py/mod_files/5ht.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/yulia/bypass/CPG_STDP/py/mod_files/5ht.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
