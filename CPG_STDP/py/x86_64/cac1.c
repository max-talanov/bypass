...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 cac1 /home/yulia/bypass/CPG_STDP/py/mod_files/cac1.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/yulia/bypass/CPG_STDP/py/mod_files/cac1.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
  "	SUFFIX cac1\n"
  "	RANGE gmax, Ev\n"
