...
nInt = 5 # 50 #19 # 196 # Number of neurons in interneuronal pools
N = 5 #5 #50
...
class NC_holder:
    ...
    def get_weights(self):
        ...
        if rank == 0:
            ...
            with hdf5.File('./res/WEIGHTS_sp_{}_CVs_{}_bs_{}.hdf5'.format(speed, CV_number, bs_fr), 'w') as file:
...
def connectcells(pre, post, weight, delay = 1, inhtype = False, N = 5, stdptype = False, threshold = 10):
