...
def read():
    ...
    for file in fnmatch.filter(os.listdir('./res_weight/'), '*.hdf5'):
    ...
    #
    # with open('time.txt', 'r', encoding='utf-8') as fh:
    #     for line in fh:
    #         line = line.rstrip('\n\r')
...
def draw(volt_data, data_time):
    ...
    for v in volt_data:
        ...
        output_file(v[0] + '.html')
        figur.line(data_time[0], v[1], line_width=2)
        show(figur)
