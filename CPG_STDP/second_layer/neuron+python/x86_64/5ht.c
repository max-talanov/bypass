...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 r5ht3a /home/max/PROJECTS/memristive-spinal-cord/memristive-spinal-cord/NEURON/second_layer/neuron+python/mod_files/5ht.mod\n");
...
static void _initlists() {
 ...
 _slist1[1] = A3D_columnindex;  _dlist1[1] = DA3D_columnindex;
 _slist1[2] = A2D_columnindex;  _dlist1[2] = DA2D_columnindex;
 _slist1[3] = AD_columnindex;  _dlist1[3] = DAD_columnindex;
 _slist1[4] = A3R_columnindex;  _dlist1[4] = DA3R_columnindex;
 _slist1[5] = A2R_columnindex;  _dlist1[5] = DA2R_columnindex;
 _slist1[6] = AR_columnindex;  _dlist1[6] = DAR_columnindex;
 _slist1[7] = C2_columnindex;  _dlist1[7] = DC2_columnindex;
 _slist1[8] = C1_columnindex;  _dlist1[8] = DC1_columnindex;
 _slist1[9] = Ol_columnindex;  _dlist1[9] = DOl_columnindex;
 _slist1[10] = Oi_columnindex;  _dlist1[10] = DOi_columnindex;
 _slist1[11] = Ob_columnindex;  _dlist1[11] = DOb_columnindex;
 _slist1[12] = Re_columnindex;  _dlist1[12] = DRe_columnindex;
_first = 0;
}

#if NMODL_TEXT
static const char* nmodl_filename = "/home/max/PROJECTS/memristive-spinal-cord/memristive-spinal-cord/NEURON/second_layer/neuron+python/mod_files/5ht.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
